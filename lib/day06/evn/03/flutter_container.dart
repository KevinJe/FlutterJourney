...
class _State extends State<FlutterContainer>
  ...
  Widget build(BuildContext context) {
    switch (widget.config.mode) {
      case FlutterMode.up_down: // 上下
        return AnimUpDown(
          animation: animation,
          child: widget.child,
        );
      case FlutterMode.left_right: // 左右
        return AnimLeftRight(
          animation: animation,
          child: widget.child,
        );
      case FlutterMode.swing: // 摇摆
        animationRotate =
